...
| № | Память | Refiner | Референс | Время | Качество (оценка автора) |
|---|---|---|---|---|---|
| 1 | normal | нет | нет | 31:22 | норм |
| 2 | auto | нет | нет | 31:31 | норм |
| 3 | normal | **да** | нет | **45:53** | чуть рябит, немного дёрганый |
| 4 | normal | нет | **да** (`fl2va`) | 32:16 | немного дёрганый |
| 5 | normal | нет | нет (`t2va`) | 31:21 | сильно рябит при движении |
